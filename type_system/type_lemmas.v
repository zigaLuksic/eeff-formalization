...
+ apply shape_summatch in orig.
  ...
  eapply c_subs_out_typesafe. exact inl. apply shape_left in vty. auto.
+ apply shape_summatch in orig.
  destruct orig as [A [B [vty [_ inr]]]].
  eapply c_subs_out_typesafe. exact inr. apply shape_right in vty. auto.
...
+ eapply shape_handle in orig. rename C into D. 
  ...
  - eapply sig_subtype_get_Some in gets; eauto.
    ...
    * apply STyCtxU. apply STyCtxU.
      apply ctx_subtype_refl; auto. apply STyFun; auto.
