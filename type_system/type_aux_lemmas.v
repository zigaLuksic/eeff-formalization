...
+ specialize (WFFL _ _ H2 A_ins (S i)) as IHwf.
...
+ specialize (JL _ _ _ H2) as IH1.
  ...
  inv H2. inv H5. auto.
+ specialize (WFFL _ _ H2 (S i) (v_shift v_s 1 0) A_s gets) as IHwf.
...
+ specialize (WFFL (CtxU Γ (TyFun TyUnit (CTy A Σ E))) _ _ H2 (S i)) as IHwf.
