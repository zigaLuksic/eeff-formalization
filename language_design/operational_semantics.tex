...
\begin{mathpar}
	...
	\inferrule*[]	{	}
	{ \match{\inleft{v}} \inleft{x} \mapsto c_1 \vsep \inright{x} \mapsto c_2
			\smallstep
		c_1\subs{x \subswith v} }

	\inferrule*[]	{	}
	{ \match{\inright{v}} \inleft{x} \mapsto c_1 \vsep \inright{x} \mapsto c_2
			\smallstep
		c_2\subs{x \subswith v} }
